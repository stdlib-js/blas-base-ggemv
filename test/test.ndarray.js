...
tape( 'the function has an arity of 15', function test( t ) {
	t.strictEqual( ggemv.length, 15, 'returns expected value' );
	t.end();
});
...
tape( 'the function throws an error if provided an invalid first argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			ggemv( value, data.M, data.N, data.alpha, data.A, data.strideA1, data.strideA2, data.offsetA, data.x, data.strideX, data.offsetX, data.beta, data.y, data.strideY, data.offsetY );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid second argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			ggemv( data.trans, value, data.N, data.alpha, data.A, data.strideA1, data.strideA2, data.offsetA, data.x, data.strideX, data.offsetX, data.beta, data.y, data.strideY, data.offsetY );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid third argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			ggemv( data.trans, data.M, value, data.alpha, data.A, data.strideA1, data.strideA2, data.offsetA, data.x, data.strideX, data.offsetX, data.beta, data.y, data.strideY, data.offsetY );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid tenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			ggemv( data.trans, data.M, data.N, data.alpha, data.A, data.strideA1, data.strideA2, data.offsetA, data.x, value, data.offsetX, data.beta, data.y, data.strideY, data.offsetY );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid fourteenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			ggemv( data.trans, data.M, data.N, data.alpha, data.A, data.strideA1, data.strideA2, data.offsetA, data.x, data.strideX, data.offsetX, data.beta, data.y, value, data.offsetY );
		};
	}
});
...
tape( 'the function performs one of the matrix-vector operations `y = α*A*x + β*y` or `y = α*A^T*x + β*y` (row-major, no-transpose)', function test( t ) {
	...
	out = ggemv( data.trans, data.M, data.N, data.alpha, a, data.strideA1, data.strideA2, data.offsetA, x, data.strideX, data.offsetX, data.beta, y, data.strideY, data.offsetY );
...
tape( 'if either `M` or `N` is `0`, the function returns the second input vector unchanged (row-major)', function test( t ) {
	...
	out = ggemv( data.trans, 0, data.N, data.alpha, a, data.strideA1, data.strideA2, data.offsetA, x, data.strideX, data.offsetX, data.beta, y, data.strideY, data.offsetY );
	t.strictEqual( out, y, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );

	out = ggemv( data.trans, data.M, 0, data.alpha, a, data.strideA1, data.strideA2, data.offsetA, x, data.strideX, data.offsetX, data.beta, y, data.strideY, data.offsetY );
	t.strictEqual( out, y, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
...
tape( 'if `α` is `0` and `β` is `1`, the function returns the second input vector unchanged (row-major)', function test( t ) {
	...
	out = ggemv( data.trans, data.M, data.N, 0.0, a, data.strideA1, data.strideA2, data.offsetA, x, data.strideX, data.offsetX, 1.0, y, data.strideY, data.offsetY );
	t.strictEqual( out, y, 'returns expected value' );
	t.deepEqual( out, expected, 'returns expected value' );
